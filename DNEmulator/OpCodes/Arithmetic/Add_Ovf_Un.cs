...
{
    public class Add_Ovf_Un : OpCodeEmulator
    {
        public override Code Code => Code.Add_Ovf_Un;
            ...
            checked
            {
                switch (firstValue.ValueType)
                {
                    ...
                    case DNValueType.Int32 when secondValue.ValueType == DNValueType.Native:
                        ctx.Stack.Push(new NativeValue(IntPtr.Add(((NativeValue)secondValue).Value, (int)(uint)((I4Value)firstValue).Value)));
                        break;
                    ...
                    case DNValueType.Native when secondValue.ValueType == DNValueType.Int32:
                        ctx.Stack.Push(new NativeValue(IntPtr.Add(((NativeValue)firstValue).Value, (int)(uint)((I4Value)secondValue).Value)));
                        break;
                    default:
